...
class CircularQueue[T <: Data](gen : T, size : Int, enqPortNum : Int, deqPortNum : Int, debug_name : String) extends Module {
  ...
  val readyPrefixMask = MaskUtil.GetPrefixMask(sizeWidth.get)(count)(enqPortNum - 1, 0)
